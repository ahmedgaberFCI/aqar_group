...
class InheritPayment(models.Model):
    ...
    account_expense = fields.Many2one("account.account", string="Account", required=False, domain="[('account_type', 'not in', ('asset_receivable', 'liability_payable'))]")
    ...
    other_account = fields.Many2one(comodel_name="account.account", string="Account Credit", required=False, domain="[('account_type', 'not in', ('asset_receivable', 'liability_payable'))]")
